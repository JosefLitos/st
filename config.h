...
static const char *colorname[] = {
	"#101010", "#cc2815", "#559915", "#cca015", "#2a648d", "#9d2098", "#42a08d", "#868380",
	"#4a4846", "#f03522", "#85f022", "#f0e822", "#3393c0", "#bd40b7", "#50e8b0", "#f0eeea",
	[255] = 0,
...
static Key key[] = {
   ...
   { XK_Delete,      ControlMask,/*↓ Changed - nvim*/"\033[3;6~",    0,  0},
